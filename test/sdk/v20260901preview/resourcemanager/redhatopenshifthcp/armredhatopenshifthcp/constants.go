...
// UsernameClaimPrefixPolicy - Prefix policy is an optional field that configures how a prefix should be applied to the value
// of the JWT claim specified in the 'claim' field.
